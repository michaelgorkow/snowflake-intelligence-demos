...
COPY FILES
  INTO @CUSTOM_TOOLS
  FROM @GITHUB_REPO_CORTEX_AGENTS_DEMO/branches/main/custom_tools/;
...
GRANT READ ON GIT REPOSITORY GITHUB_REPO_CORTEX_AGENTS_DEMO TO ROLE AI_ENGINEER;

-- Setup Custom Tools for Agents
EXECUTE IMMEDIATE FROM @AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_CORTEX_AGENTS_DEMO/branches/main/setup_custom_tools.sql;
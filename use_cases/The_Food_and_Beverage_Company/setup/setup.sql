...
CREATE NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_2_RAG
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS/branches/main/use_cases/The_Food_and_Beverage_Company' 
        QUERY_WAREHOUSE = 'AI_WH'
        EXTERNAL_ACCESS_INTEGRATIONS = ('ai_external_access_integration')
        COMPUTE_POOL = 'SYSTEM_COMPUTE_POOL_CPU'
        RUNTIME_NAME = 'SYSTEM$BASIC_RUNTIME'
        MAIN_FILE = 'SI_THE_FOOD_AND_BEVERAGE_COMPANY_2_RAG.ipynb';
ALTER NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_2_RAG ADD LIVE VERSION FROM LAST;

CREATE NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_3_AISQL
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS/branches/main/use_cases/The_Food_and_Beverage_Company' 
        QUERY_WAREHOUSE = 'AI_WH'
        EXTERNAL_ACCESS_INTEGRATIONS = ('ai_external_access_integration')
        COMPUTE_POOL = 'SYSTEM_COMPUTE_POOL_CPU'
        RUNTIME_NAME = 'SYSTEM$BASIC_RUNTIME'
        MAIN_FILE = 'SI_THE_FOOD_AND_BEVERAGE_COMPANY_3_AISQL.ipynb';
ALTER NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_3_AISQL ADD LIVE VERSION FROM LAST;

CREATE NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_4_SEMANTIC_VIEWS
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS/branches/main/use_cases/The_Food_and_Beverage_Company' 
        QUERY_WAREHOUSE = 'AI_WH'
        EXTERNAL_ACCESS_INTEGRATIONS = ('ai_external_access_integration')
        COMPUTE_POOL = 'SYSTEM_COMPUTE_POOL_CPU'
        RUNTIME_NAME = 'SYSTEM$BASIC_RUNTIME'
        MAIN_FILE = 'SI_THE_FOOD_AND_BEVERAGE_COMPANY_4_SEMANTIC_VIEWS.ipynb';
ALTER NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_4_SEMANTIC_VIEWS ADD LIVE VERSION FROM LAST;

CREATE NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_5_CUSTOM_TOOLS
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS/branches/main/use_cases/The_Food_and_Beverage_Company' 
        QUERY_WAREHOUSE = 'AI_WH'
        EXTERNAL_ACCESS_INTEGRATIONS = ('ai_external_access_integration')
        COMPUTE_POOL = 'SYSTEM_COMPUTE_POOL_CPU'
        RUNTIME_NAME = 'SYSTEM$BASIC_RUNTIME'
        MAIN_FILE = 'SI_THE_FOOD_AND_BEVERAGE_COMPANY_5_CUSTOM_TOOLS.ipynb';
ALTER NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_5_CUSTOM_TOOLS ADD LIVE VERSION FROM LAST;
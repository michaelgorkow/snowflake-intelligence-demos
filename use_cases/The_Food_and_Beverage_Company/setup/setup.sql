...
COPY FILES
  INTO @__DATA
  FROM @PUBLIC.GITHUB_REPO_CORTEX_AGENTS_DEMO/branches/main/use_cases/The_Food_and_Beverage_Company/data_generation/01_tables/data/;
ALTER STAGE __DATA REFRESH;

-- Copy documents into stages
COPY FILES
  INTO @DOCUMENTS
  FROM @PUBLIC.GITHUB_REPO_CORTEX_AGENTS_DEMO/branches/main/use_cases/The_Food_and_Beverage_Company/data_generation/03_documents/data/;
ALTER STAGE DOCUMENTS REFRESH;

-- Create Notebooks
CREATE NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_1_DATA_GENERATION
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_CORTEX_AGENTS_DEMO/branches/main/use_cases/The_Food_and_Beverage_Company' 
...
CREATE NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_2_UNSTRUCTURED_DATA
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_CORTEX_AGENTS_DEMO/branches/main/use_cases/The_Food_and_Beverage_Company' 
        QUERY_WAREHOUSE = 'AI_WH'
        EXTERNAL_ACCESS_INTEGRATIONS = ('ai_external_access_integration')
        COMPUTE_POOL = 'SYSTEM_COMPUTE_POOL_CPU'
        RUNTIME_NAME = 'SYSTEM$BASIC_RUNTIME'
        MAIN_FILE = 'SI_THE_FOOD_AND_BEVERAGE_COMPANY_2_UNSTRUCTURED_DATA.ipynb';
ALTER NOTEBOOK SI_THE_FOOD_AND_BEVERAGE_COMPANY_2_UNSTRUCTURED_DATA ADD LIVE VERSION FROM LAST;
